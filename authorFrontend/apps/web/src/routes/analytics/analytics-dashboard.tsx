    ...
    <div className="space-y-6 text-xs">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="text-[11px] text-slate-500 font-mono">
          Last refreshed: <strong className="text-slate-800 dark:text-slate-300">Live Telemetry (16 Sep 2026)</strong>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-1 shadow-xs">
          ...
          <div className="font-mono text-xl font-black text-slate-900 dark:text-white">418,920</div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-1 shadow-xs">
          ...
          <div className="font-mono text-xl font-black text-slate-900 dark:text-white">92,410</div>
          <div className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold flex items-center gap-1">
            <TrendingUp className="h-3 w-3" />
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-1 shadow-xs">
          ...
          <div className="font-mono text-xl font-black text-slate-900 dark:text-white">34,180</div>
          <div className="text-[10px] text-slate-500 dark:text-slate-400 font-mono">88.4% completion rate</div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-1 shadow-xs">
          ...
          <div className="font-mono text-xl font-black text-emerald-600 dark:text-emerald-400">94.8%</div>
          <div className="text-[10px] text-slate-500 dark:text-slate-400 font-mono">Avg resolution: 4.2 days</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 space-y-4 shadow-xs">
          <h3 className="font-bold text-slate-900 dark:text-white text-sm">Top Research Search Queries (Last 30 Days)</h3>
          <div className="space-y-2">
            {[
              ...
              <div key={idx} className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center justify-between">
                <span className="font-medium text-slate-800 dark:text-slate-200">{q.query}</span>
                <div className="flex items-center gap-3 font-mono text-[11px]">
                  <span className="text-amber-700 dark:text-amber-400 font-bold">{q.count.toLocaleString()} queries</span>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 space-y-4 shadow-xs">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-slate-900 dark:text-white text-sm">Outbound Verification & Affiliate Clicks</h3>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={idx} className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center justify-between">
                <div>
                  <div className="font-bold text-slate-900 dark:text-slate-200">{b.broker}</div>
