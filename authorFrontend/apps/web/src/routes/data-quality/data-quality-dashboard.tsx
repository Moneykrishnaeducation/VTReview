  ...
  return (
    <div className="space-y-6 text-xs">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-orange-950/60 border border-orange-800 text-orange-300 font-mono text-[11px] mb-1">
          ...
          {issues.map((item) => (
            <div
              ...
              className={`p-4 flex flex-wrap items-center justify-between gap-4 transition-colors ${
                item.resolved ? "bg-slate-950/40 opacity-60" : "hover:bg-slate-850/40"
              }`}
            >
              <div className="space-y-1 max-w-2xl">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {item.resolved && (
                    <span className="px-2 py-0.2 rounded bg-emerald-950 text-emerald-300 border border-emerald-800 text-[10px] font-bold">
                      RESOLVED
                    </span>
                  )}
                </div>
              ...
              {!item.resolved && (
                <button
                  ...
                  className="px-3.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold rounded-lg border border-slate-700 flex items-center gap-1.5 transition-colors cursor-pointer"
                >
