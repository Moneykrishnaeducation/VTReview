    ...
    <div className="space-y-6 text-xs">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-3.5 py-1.5 bg-slate-900 hover:bg-slate-800 text-amber-400 rounded-lg font-bold border border-slate-800 transition-colors cursor-pointer"
        >
          Mark All As Read
        </button>
      </div>
          ...
          <div
            ...
            className={`p-4 rounded-2xl border transition-all flex flex-wrap items-center justify-between gap-4 ${
              n.read
                ...
                : "bg-slate-900 border-amber-500/40 shadow-xs text-slate-200 ring-1 ring-amber-500/10"
            }`}
          >
            <div className="space-y-1 max-w-2xl">
              <div className="flex items-center gap-2">
                {!n.read && <span className="h-2 w-2 rounded-full bg-amber-400 animate-ping" />}
